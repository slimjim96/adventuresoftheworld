...
### Key Features
- 🚂 **Auto-scrolling cart gameplay** - Simple one-button jump mechanic
- 🌍 **5 Unique Worlds** - Forest, Mountain, Desert, Underwater, Ocean
- 🦁 **Playable Animal Characters** - Lion, Bunny, Duck, Mouse
- 🪙 **Progression System** - Collect coins to unlock characters and upgrades
- ⭐ **Score & Star Ratings** - Compete for 3-star ratings on each level
...
│   ├── project-scope.md       # Project scope & timeline
│   └── game-design.md         # Game design document
│
├── Assets/                    # Unity assets (created during development)
│   ├── Scenes/                # Game scenes
...
### Month 1: Foundation & Core Mechanics ✅
